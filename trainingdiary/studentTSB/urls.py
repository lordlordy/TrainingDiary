...
from studentTSB.views import (home_view, player_list_view, coach_list_view, event_list_view, team_list_view, team_view,
                              ...
                              event_generate_team_view, event_generate_player_view, event_occurrence_view,
                              player_event_occurrence_view_from_player_view,
                              ...
                              reading_edit, reading_update, delete_reading, add_teams_to_event_view,
                              event_occurrence_states_list_view, new_event_occurrence_state,
                              update_event_occurrence_state, delete_event_occurrence_state)
