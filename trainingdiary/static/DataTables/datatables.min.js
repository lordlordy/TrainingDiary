...
f=e.bPaginate;return e.bServerSide?!1===f||-1===a?b+d:Math.min(b+a,this._iRecordsDisplay):!f||c>d||-1===a?d:c},oInstance:null,sInstance:null,iTabIndex:0,nScrollHead:null,nScrollFoot:null,aLastSort:[],oPlugins:{},rowIdFn:null,rowId:null};u.ext=L={buttons:{},classes:{},build:"bs4/dt-1.10.24/e-2.0.2/b-1.7.0/sl-1.3.3",errMode:"alert",feature:[],search:[],selector:{cell:[],column:[],row:[]},internal:{},legacy:{ajax:null},pager:{},renderer:{pageButton:{},header:{}},order:{},type:{detect:[],search:{},order:{}},_unique:0,fnVersionCheck:u.fnVersionCheck,
...
P=function(a){return a instanceof d.fn.dataTable.Api?a:d(a).DataTable()},sa=function(a){a=d(a);setTimeout(function(){a.addClass("highlight");setTimeout(function(){a.addClass("noHighlight").removeClass("highlight");setTimeout(function(){a.removeClass("noHighlight")},550)},500)},20)},ta=function(a,b,c,e,f){b.rows(c).indexes().each(function(h){h=b.row(h);var g=h.data(),k=f(g);k===m&&y.error("Unable to find row identifier",14);a[k]={idSrc:k,data:g,node:h.node(),fields:e,type:"row"}})},Ha=function(a,b,
