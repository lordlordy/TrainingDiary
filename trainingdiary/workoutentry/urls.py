...
urlpatterns = [
    ...
    path('race_results/delete/<str:date>/<int:race_number>/', login_required(RaceResultUpdateView.as_view()), name='race_result_form'),
    path('race_results/<str:date>/<int:race_number>/', login_required(RaceResultDeleteView.as_view()),
         name='race_result_delete'),
