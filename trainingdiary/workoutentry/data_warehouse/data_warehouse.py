...
class DataWarehouse:
    ...
    popular_numbers = {
        ...
        'Weekly Swim KM': {ACTIVITY: 'Swim', MEASURE: 'km', PERIOD: 'W-Sun'},
        'Weekly Bike Miles': {ACTIVITY: 'Bike', MEASURE: 'miles', PERIOD: 'W-Sun'},
        'Weekly Run Miles': {ACTIVITY: 'Run', MEASURE: 'miles', PERIOD: 'W-Sun'},
